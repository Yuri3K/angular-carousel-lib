...
@Component({
  selector: 'app-root',
  imports: [NgxCarouselComponent, SlideComponent, ControlsComponent],
...
export class AppComponent {
  slides = [
    {
      ...
      subtitle: '50% OFF',
      descr:
        'Only from July 7 to 13 — up to 50% off seasonal fruits and veggies. Don’t miss out!',
      btn: 'Buy Now',
      link: '/',
    },
    {
      ...
      descr:
        'From July 12 to 15, enjoy discounts on homegrown, juicy tomatoes!',
      btn: 'Buy Now',
      link: '/',
    },
    {
  ...
  nonStopConfig: NgxCarouselConfig = {
    mode: 'non-stop',
    nonStopSpeed: 330,
    slidesToShow: 1,
    showDots: false,
